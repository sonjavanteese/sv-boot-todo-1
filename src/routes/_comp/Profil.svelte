...
{:then data}
  {#each data as udata}
    ...
    <section {...$$restProps}>
      <div class="position-relative p-4 border rounded-2">
        <a
        ...
        <div class="d-flex mb-3 align-items-center justify-content-between">
         ...
         <div class="d-flex mb-1 align-items-center justify-content-between">
          ...
          <p class="mb-0 fw-light">{$_user && $_user.email ? $_user.email : "no user"}</p>
        </div>
        <hr class="mb-3" />
        <!-- ButtonBar -->
        <footer class="d-flex align-items-center justify-content-center">
          <button
            class="btn me-4 w-100 btn-outline-primary d-flex align-items-center justify-content-center"
          >
            <span>Edit</span>
          </button>
          <button
